        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:justify-around justify-center items-center gap-8">
          ...
          <div className="">
            <p className="leading-8 capitalize md:w-10/12 w-full text-gray-800 dark:text-gray-200">
              I'm Ishak Djilali Benfredj, I Work As A software engineer and
              content creator . When you work with me, I will be keen to
              fulfill your requests. I will try to provide wonderful additions
              to your project and help you with awesome marketing ideas for the
              success of your business. What are you waiting for? Contact me to
              work and you can also download my CV via the button:
            </p>
